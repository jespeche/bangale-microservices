...
@Service
@Transactional
class ProductServiceImpl(private val repository: ProductRepository, private val publisher: ApplicationEventPublisher) : ProductService {
    ...
    private fun publish(event: ProductEvent) = publisher.publishEvent(event)
}